...
module.exports = {
  ...
  theme: {
    extend: {
      // Shadcn/ui color variables mapped to comprehensive UCRS design system
      colors: {
        ...
        primary: {
          ...
          // Extended UCRS Primary Red Scale
        ...
        secondary: {
          ...
          // Extended UCRS Secondary Blue Scale
      ...
      // Enhanced Typography from UCRS Design System
      fontFamily: {
        primary: ['var(--font-primary)', 'Inter', '-apple-system', 'BlinkMacSystemFont', "'Segoe UI'", 'Roboto', 'sans-serif'],
      ...
      // Enhanced Spacing System from UCRS Design System
      spacing: {
      ...
      // UCRS Responsive Breakpoints from DesignSystem.json
      screens: {
      ...
      // Responsive utilities based on UCRS breakpoints
      container: {
        screens: {
          sm: '640px',
          md: '768px',
